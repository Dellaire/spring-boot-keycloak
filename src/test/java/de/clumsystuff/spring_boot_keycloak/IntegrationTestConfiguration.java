...
public class IntegrationTestConfiguration {
    ...
    /**
     * This bean is used by the Keycloak adapter, it holds the properties required to operate with Keycloak. When
     * running the application in a normal way, there is an instance available. However, for some reason, there is
